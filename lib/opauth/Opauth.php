...
class Opauth
{
    ...
    public function run ()
    {
        ...
        if (!empty($this->env['params']['strategy']))
        {
            ...
            elseif (array_key_exists(strtolower($this->env['params']['strategy']), $this->strategyMap))
            {
    ...
    private function parseUri ()
    {
        ...
        {
            $this->env['params']['strategy'] = $_POST['loginType'];
        }
        ...
        {
            $this->env['params']['action'] = isset($_POST['loginAction']) ? $_POST['loginAction'] : 'login';
        }
    }
